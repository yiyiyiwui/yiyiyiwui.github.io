...
<span class="line"><span>  data-source-proxy-mode: XA</span></span></code></pre></div><p>然后在入口添加全局事务注解</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>@GlobalTransactional //开启全局事务</span></span></code></pre></div>`,66)])])}const A=s(d,[["render",h]]);export{x as __pageData,A as default};
