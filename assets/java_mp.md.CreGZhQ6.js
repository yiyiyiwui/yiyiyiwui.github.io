import{_ as a,o as n,c as p,ah as e,aI as l,aJ as t}from"./chunks/framework.Df4DMI_z.js";const b=JSON.parse('{"title":"MybatisPlus","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"java/mp.md","filePath":"java/mp.md","lastUpdated":1779161385000}'),i={name:"java/mp.md"};function r(c,s,d,o,u,g){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="mybatisplus" tabindex="-1">MybatisPlus <a class="header-anchor" href="#mybatisplus" aria-label="Permalink to “MybatisPlus”">​</a></h1><blockquote><p>自动填充 时间、分页插件、逻辑删除、代码生成器</p></blockquote><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to “使用”">​</a></h2><p>导入依赖</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>&lt;!--mybatis plus依赖--&gt;</span></span>
