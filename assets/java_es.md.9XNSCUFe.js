...
<span class="line"><span>kibana:7.12.1</span></span></code></pre></div><p>Kibana启动比较慢，我们稍等一会，可以查看运行日志：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>docker logs -f kibana</span></span></code></pre></div><h3 id="问题-词条可以自己设定都有哪些词吗" tabindex="-1">问题：词条可以自己设定都有哪些词吗？ <a class="header-anchor" href="#问题-词条可以自己设定都有哪些词吗" aria-label="Permalink to “问题：词条可以自己设定都有哪些词吗？”">​</a></h3><p>可以安装IK分词器，分词器有两种模式 同时如果我们要新创建词语的话，也可以在IKAnalyzer.cfg.xml配置文件内容中修改添加</p><ul><li>ik_smart：最少切分</li><li>ik_max_word：最细切分</li></ul><h3 id="什么是索引库-什么是文档" tabindex="-1">什么是索引库？什么是文档？ <a class="header-anchor" href="#什么是索引库-什么是文档" aria-label="Permalink to “什么是索引库？什么是文档？”">​</a></h3><p>索引库就相当于mysql里面的一张表，文档就是存储的一行一行的数据，只不过是按照json格式存储的 <img src="`+t+`" alt=""> 添加索引库：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>PUT /heima</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="问题-连接好了-接下来怎么创建索引库呢" tabindex="-1">问题：连接好了，接下来怎么创建索引库呢？ <a class="header-anchor" href="#问题-连接好了-接下来怎么创建索引库呢" aria-label="Permalink to “问题：连接好了，接下来怎么创建索引库呢？”">​</a></h3><p><img src="`+l+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>//创建一个请求  括号里的是索引库名称，不用加/ ，会自动识别</span></span>
...
<span class="line"><span>        AcknowledgedResponse delete = client.indices().delete(hotel,RequestOptions.DEFAULT); //删除</span></span></code></pre></div><h3 id="问题-索引库有了-怎么添加文档呢" tabindex="-1">问题：索引库有了，怎么添加文档呢？ <a class="header-anchor" href="#问题-索引库有了-怎么添加文档呢" aria-label="Permalink to “问题：索引库有了，怎么添加文档呢？”">​</a></h3><p><img src="`+o+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>//这里我们新创建一个类</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><h3 id="问题-怎么查看文档" tabindex="-1">问题：怎么查看文档？ <a class="header-anchor" href="#问题-怎么查看文档" aria-label="Permalink to “问题：怎么查看文档？”">​</a></h3><p><img src="`+c+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>//创建请求对象（输入索引库名称和查询的id）</span></span>
...
<span class="line"><span>  client.bulk(request, RequestOptions.DEFAULT);</span></span></code></pre></div><h3 id="es有了数据库了-怎么查询呢" tabindex="-1">ES有了数据库了，怎么查询呢？ <a class="header-anchor" href="#es有了数据库了-怎么查询呢" aria-label="Permalink to “ES有了数据库了，怎么查询呢？”">​</a></h3><p>常见的查询类型分为4类： <img src="`+h+'" alt=""> 第一个是查询所有数据用于测试： <img src="'+r+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 查看全部数据</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="全文检索查询" tabindex="-1">全文检索查询： <a class="header-anchor" href="#全文检索查询" aria-label="Permalink to “全文检索查询：”">​</a></h4><p>一般用于输入关键字查询，得到词条后会去倒排索引库匹配关键字，查询需要的文档，返回用户。</p><p>可以理解为你要去图书馆找一本书，要根据书的名字取对应的书架找需要的书。</p><p><strong>match查询：根据字段名查找</strong><img src="`+d+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 全文检索</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><strong>multi_match查询：与match查询类似，只不过允许同时查询多个字段。</strong><img src="`+u+`" alt=""></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 全文检索多个</span></span>
<span class="line"><span>GET /hotel/_search</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>  &quot;query&quot;: {</span></span>
